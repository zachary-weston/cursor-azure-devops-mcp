...
async function testConnection() {
    ...
    try {
        ...
        console.error('- AZURE_DEVOPS_ORG_URL should be in the format: https://dev.azure.com/your-organization');
        console.error('- AZURE_DEVOPS_TOKEN should be a valid personal access token with appropriate permissions');
        return false;
    }
}
// Run the test
